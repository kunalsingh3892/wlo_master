...
class _ChangePageState extends State<CustomerList11> {
  ...
  void _myProfileData(String query,int page) async {
    ...
    if (page <= t2) {
      ...
      var uri;
      if(query==""){
        uri = Uri.parse(URL+'customers')
            .replace(query: "page=$page");
      }
      else{
        uri = Uri.parse(URL+'customers')
            .replace(query: query);
                            ...
                            Expanded(
                              child: ButtonTheme(
                                ...
                                child: RaisedButton(
                                  ...
                                  color:
                                  isEnabled5 ? Color(0xffb5322f) : Color(0xfffbefa7),
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled5 = true;
                                      isEnabled6 = false;
                                      users.clear();
                                      _myProfileData("page=$current_page&sort=-customer_id",current_page);
                            ...
                            Expanded(
                              child: ButtonTheme(
                                ...
                                child: RaisedButton(
                                  ...
                                  color:
                                  isEnabled6 ? Color(0xffb5322f) :Color(0xfffbefa7),
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled6 = true;
                                      isEnabled5 = false;
                                ...
                                child: RaisedButton(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.only(
                                          ...
                                          bottomLeft: Radius.circular(25))),
                                  color:
                                  isEnabled7 ? Color(0xffb5322f) : Color(0xfffbefa7),
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled7 = true;
                                      isEnabled8 = false;
                                      users.clear();
                                      _myProfileData("page=$current_page&sort=-customer_businessname",current_page);
                                ...
                                child: RaisedButton(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.only(
                                          ...
                                          bottomRight: Radius.circular(25))),
                                  color:
                                  isEnabled8 ? Color(0xffb5322f) :Color(0xfffbefa7),
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled8= true;
                                      isEnabled7 = false;
                                ...
                                child: RaisedButton(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.only(
                                          ...
                                          bottomLeft: Radius.circular(25))),
                                  color:
                                  isEnabled9 ? Color(0xffb5322f) : Color(0xfffbefa7),
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled9 = true;
                                      isEnabled10 = false;
                                      users.clear();
                                      _myProfileData("page=$current_page&sort=-postcode",current_page);
                                ...
                                child: RaisedButton(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.only(
                                          ...
                                          bottomRight: Radius.circular(25))),
                                  color:
                                  isEnabled10 ? Color(0xffb5322f) :Color(0xfffbefa7),
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled10 = true;
                                      isEnabled9 = false;
  ...
  TextStyle normalTex4 = GoogleFonts.montserrat(
    fontSize: 15, fontWeight: FontWeight.w400, color: Colors.blue, decoration: TextDecoration.underline,);
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (text1)
                                  {
                                    ...
                                    _myProfileData("page=$current_page&postcode=${postCodeController.text}",current_page);

                                    if(text2){
                                      _myProfileData("page=$current_page&postcode=${postCodeController.text}&customer_accountnumber=${postCodeController.text}",current_page);

                                        if(text3){

                                        _myProfileData("page=$current_page&postcode=${postCodeController.text}&customer_accountnumber=${postCodeController.text}&customer_businessname=${postCodeController.text}",current_page);
                                      }
                                    }
                                    else if(text3){
                                      _myProfileData("page=$current_page&postcode=${postCodeController.text}&customer_businessname=${bNameController.text}",current_page);
                                  ...
                                  else if (text2)
                                  {
                                    ...
                                    _myProfileData("page=$current_page&customer_accountnumber=${accountNoController.text}",current_page);


                                    if(text1){
                                      _myProfileData("page=$current_page&postcode=${postCodeController.text}&customer_accountnumber=${accountNoController.text}",current_page);
                                      ...
                                      _myProfileData("page=$current_page&customer_accountnumber=${bNameController.text}&customer_accountnumber=${accountNoController.text}",current_page);
                                    ...
                                    _myProfileData("page=$current_page&customer_businessname=${bNameController.text}",current_page);

                                    if(text2){
                                      _myProfileData("page=$current_page&customer_businessname=${postCodeController.text}&customer_accountnumber=${accountNoController.text}",current_page);

                                      if(text1){
                                        _myProfileData("page=$current_page&postcode=${postCodeController.text}&customer_accountnumber=${postCodeController.text}&customer_businessname=${bNameController.text}",current_page);

                                      }
                                    }
                                    else if(text1){
                                      _myProfileData("page=$current_page&customer_businessname=${bNameController.text}&postcode=${postCodeController.text}",current_page);

                                      if(text1){
                                        _myProfileData("page=$current_page&postcode=${postCodeController.text}&customer_accountnumber=${accountNoController.text}&customer_businessname=${bNameController.text}",current_page);
  ...
  TextStyle normalText6 = GoogleFonts.montserrat(
      fontSize: 15, fontWeight: FontWeight.w400, color: Color(0xff000000),decoration: TextDecoration.underline);
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      Navigator.pushNamed(
                        ...
                        '/edit-customer',
                        arguments: <String, String>{
                          'customer_id':_searchResult[index]
                ...
                return InkWell(
                  onTap: () {
                    Navigator.pushNamed(
                      ...
                      '/add-newjob',
                      arguments: <String, String>{
                        'cust_id': users[index]['customer_id']
                            .toString(),
                      },
                    );
                  },
                  child: Container(
                    padding: EdgeInsets.only(left: 8,right: 5,top: 7,bottom: 7),
                    margin: EdgeInsets.only(bottom: 12),
                    decoration: BoxDecoration(
                        color: Colors.white,
                        border:
                      ...
                      InkWell(
                        onTap: (){
                          ...
                          Navigator.pushNamed(
                            ...
                            '/edit-customer',
                            arguments: <String, String>{
                              'customer_id':users[index]['customer_id'].toString()
                            },
                          );
                        },
                        child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(child:  ListView(
                          shrinkWrap: true,
                          controller: _sc, children: <Widget>[
                        Center(
                          child: Container(
