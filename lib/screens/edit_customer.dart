...
class _ChangePageState extends State<EditCustomers> {
  ...
  Future _sicListData() async {
    ...
    var response = await http.get(
      new Uri.https(BASE_URL, API_PATH + "/sics"),
      headers: headers,
    );
  ...
  Future _getParentAccount() async {
    ...
    var response = await http.get(
      new Uri.https(BASE_URL, API_PATH + "/customer/parent-accounts"),
      headers: headers,
    );
    if (response.statusCode == 200) {
      setState(() {
  ...
  Future _getZoneAccount() async {
    ...
    var response = await http.get(
      new Uri.https(BASE_URL, API_PATH + "/zones"),
      headers: headers,
    );
    if (response.statusCode == 200) {
      var data = json.decode(response.body);
  ...
  Future _getAccount(String businessName, String postCode) async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/customer/generate-account-number"),
      body: {
        "customer_businessname": businessName,
        "customer_parentaccount": postCode
      },
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      if (postCodeController.text != "") {
                        ...
                        var response = await http.post(
                          new Uri.https(
                              BASE_URL, API_PATH + "/postcode/look-up"),
                      ...
                      if (selectedDealer != "") {
                        if (sent_id != null) {
                          ...
                          var response = await http.put(
                            URL + "customer/$customer_id/update",
                            body: _type == "null"
                                ? jsonEncode({
                                    "sic_id": int.parse(selectedDealer),
