...
class _ChangePageState extends State<CollectionDetails> {
  ...
  Future _checkListData() async {
    ...
    var response = await http.get(
      new Uri.https(BASE_URL, API_PATH + "/job-collection/$job_id"),
      headers: headers,
    );
                    ...
                    Align(
                      ...
                      child: Container(
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Text(
                                response['collection_qty']+" Litres",
                                softWrap: true,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: normalTex2),
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Html(data:html_currency_code+" "+response['collection_vat'],
                                defaultTextStyle: normalTex2),
                          ),
                        ]),
                      ),
                    ),
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Html(data:html_currency_code+" "+response['collection_amount'],
                                defaultTextStyle: normalTex2),
                          ),
                        ]),
                      ),
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Text(response['consignment']['consignment_number'],
                                softWrap: true,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: normalTex2),
