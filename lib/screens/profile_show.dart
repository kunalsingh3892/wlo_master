...
class _ChangePageState extends State<ProfileShow> {
  ...
  TextStyle normalText4 = GoogleFonts.montserrat(
      fontSize: 14, fontWeight: FontWeight.w300, color: Color(0xff000000),decoration: TextDecoration.underline,);
                      ...
                      child: Material(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(response['email'],style: normalText4,),
                            SizedBox(
                              height: 20.0,
                            ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Material(
                          ...
                          child: CircleAvatar(
                            radius: 40.0,
                            backgroundImage: profile_pic!=''?NetworkImage(profile_pic):AssetImage("assets/images/avatar.png"),
                          ),
                        ),
                      ],
                    ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Expanded(child: Text("View Checklist", style: normalText1)),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Expanded(child: Text("Change Password", style: normalText1)),
