                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () async {
                                  setState(() {
                                    isEnabled5 = true;
                                    isEnabled6 = false;
                                    _checkList = _checkListData("page=$page&sort=-customer_id",page);
                                  });
                                },
                                child:
                                  Text(
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled7 = true;
                                      isEnabled8 = false;
                                      _checkList = _checkListData("page=$page&sort=-customer_businessname",page);
                                    });
                                  },
                                  child:
                                  Text(
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () async {
                                    setState(() {
                                      isEnabled9 = true;
                                      isEnabled10 = false;
                                      _checkList = _checkListData("page=$page&sort=-postcode",page);
                                    });
                                  },
                                  child:
                                  Text(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () {
                                Navigator.pop(context);
                                  if (text1)
                                  {
                                    _checkList = _checkListData("postcode=${postCodeController.text}", page);

                                    if(text2){
                                      _checkList = _checkListData("postcode=${postCodeController.text}&customer_accountnumber=${postCodeController.text}", page);
                                      if(text3){
                                        _checkList = _checkListData("postcode=${postCodeController.text}"
                                            "&customer_accountnumber=${postCodeController.text}&customer_businessname=${postCodeController.text}", page);

                                      }
                                    }
                                    else if(text3){
                                      _checkList = _checkListData("postcode=${postCodeController.text}&customer_businessname=${bNameController.text}", page);
                                      if(text2){
                                        _checkList = _checkListData("postcode=${postCodeController.text}"
                                            "&customer_accountnumber=${postCodeController.text}&customer_businessname=${postCodeController.text}", page);
                                  ...
                                  else if (text2)
                                  {
                                    ...
                                    if(text1){
                                      _checkList = _checkListData("postcode=${postCodeController.text}&customer_accountnumber=${accountNoController.text}", page);
                                      if(text3){
                                        _checkList = _checkListData("postcode=${postCodeController.text}"
                                            "&customer_accountnumber=${postCodeController.text}&customer_businessname=${postCodeController.text}", page);
                                      ...
                                      _checkList = _checkListData("customer_accountnumber=${bNameController.text}&customer_accountnumber=${accountNoController.text}", page);
                                      if(text1){
                                        _checkList = _checkListData("postcode=${postCodeController.text}"
                                            "&customer_accountnumber=${postCodeController.text}&customer_businessname=${postCodeController.text}", page);
                                    ...
                                    if(text2){
                                      _checkList = _checkListData("customer_businessname=${postCodeController.text}&customer_accountnumber=${accountNoController.text}", page);
                                      if(text1){
                                        _checkList = _checkListData("postcode=${postCodeController.text}"
                                            "&customer_accountnumber=${postCodeController.text}&customer_businessname=${bNameController.text}", page);

                                      }
                                    }
                                    else if(text1){
                                      _checkList = _checkListData("customer_businessname=${bNameController.text}&postcode=${postCodeController.text}", page);
                                      if(text1){
                                        _checkList = _checkListData("postcode=${postCodeController.text}"
                                            "&customer_accountnumber=${accountNoController.text}&customer_businessname=${bNameController.text}", page);
