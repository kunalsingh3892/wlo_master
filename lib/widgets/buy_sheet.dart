...
class BuySheetState extends State<BuySheet> {
  ...
  Future<void> printCurlCommand(String nonce, String verificationToken) async {
    ...
    if (verificationToken == null) {
      ...
      var response = await http.post("$hostUrl/v2/payments",
        body:jsonEncode({
          "idempotency_key": uuid,
          "amount_money": {
      ...
      if (response.statusCode == 200) {
        Fluttertoast.showToast(
            msg: "Payment done successfully - " +data['payment']['id'].toString(), toastLength: Toast
            .LENGTH_SHORT);
          ...
          _loading = true;
                    ...
                    Map<String, String> headers = {
                      ...
                      uploadRequest.fields['collection_vat'] =
                          widget.collection_vat;
                      uploadRequest.fields['collection_amount'] = widget.collection_amount;
                      uploadRequest.fields['collection_signatory'] = widget.collection_signatory;
                        ...
                        if (response.statusCode == 201) {
                          ...
                          Navigator.pushNamed(
                            ...
                            arguments: <String, String>{
                              ...
                              'collection_amount': data['data']['collection_amount'].toString(),
                              'collection_number': data['data']['collection_number'].toString(),
                              'collection_date': data['data']['collection_date'].toString(),
                              'consignment_no': data['data']['consignment']['consignment_number'].toString(),
                              'product_info': data['data']['product']['product_name'].toString()+" - "+data['data']['product']['product_ewc'].toString(),
                            },
                          );
                                    ...
                                    Expanded(
                                        child: Container(
                                          ...
                                          child: Container(
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: 12, vertical: 10),
                                              child: Text(widget.collection_qty,
                                                style: normalText2,)),
                                        )
                                    ),
                                    SizedBox(
                                    ...
                                    Expanded(
                                        child: Container(
                                            ...
                                            child:Container(
                                              ...
                                              child: Html(data:html_currency_code+" "+widget.amount),
                                            )
                                        )
                                    )
                                  ]),
